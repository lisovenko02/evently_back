...
//     const { eventId, receiverEventId, content, isGroupMessage, chatGroupId } =
//       createMessageDto;
...
//         eventId,
//         isGroupMessage,
//         chatGroupId: isGroupMessage ? chatGroupId : null,
...
//   async getMessagesForEvent(eventId: number, user: User) {
//     const userInEvent = await this.prisma.eventUser.findFirst({
//       where: { eventId, userId: user.id },
//     });
